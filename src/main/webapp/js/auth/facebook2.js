				    				...
				    				function(){
				            			...
				            			$.getJSON("../../common/fbPhoto.json?filename=" + image.replace(/&/gi, '%26'), function(ajaxResult) {
				  						...
				  						/*if (image == defaulturl) {
				  							...
				  							var fcbk_photo = image.split('/')[6].split('?')[0]; //6  
				  						//}
				  						console.log(fcbk_photo);
  ...
  // Load the SDK asynchronously
	 (function(d, s, id) {
	  ...
	  js.src = "//connect.facebook.net/ko_KR/sdk.js#xfbml=1&version=v2.8&appId=1839903589598946";
